...
export const sectors: Sector[] = [
  ...
  },
  {
    ...
    group: "Professional services",
    tagline: "Client reporting that builds itself, and retainer profitability you can see.",
    intro:
      "Agencies lose a week a month rebuilding the same client reports by hand, and still cannot say which accounts make money. We build one reporting spine across every client and platform, and put delivery hours against fee.",
    pains: [
      ...
      "Scope creep invisible until the account is underwater",
    ],
    builds: [
      ...
      "Early warning on accounts drifting out of scope",
    ],
    outputs:
      "The reporting week disappears, and you finally know which accounts actually make money.",
    metrics: ["Retainer margin", "Hours to fee", "Media margin", "Client retention", "Revenue per head"],
  },
  {
