...
import { caseStudiesForSector } from "@/lib/case-studies";
...
export default async function SectorPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const studies = caseStudiesForSector(sector.slug);
    ...
    <>
      ...
      <section className="py-16 md:py-20 border-b border-white/[0.04]">
        <div className="container">
          <Eyebrow className="mb-5">The numbers that matter here</Eyebrow>
        ...
        <div className="container grid gap-5 lg:grid-cols-3">
          <Card className="p-7">
            <CardContent className="p-0">
              <Eyebrow className="mb-4">Where it hurts</Eyebrow>
          ...
          <Card className="p-7 border-electric/30 bg-gradient-to-b from-electric/[0.05] to-transparent">
            <CardContent className="p-0">
              <Eyebrow accent className="mb-4">What Acta builds</Eyebrow>
              <ul className="space-y-3 text-sm text-foreground/90">
                {sector.builds.map(b => (
      ...
      {/* Renders only when a case study exists for this sector. */}
      <CaseStudySection
        studies={studies}
        heading="Proof"
      ...
      <section className="py-20 md:py-24 border-t border-white/[0.04]">
        <div className="container">
          <Eyebrow className="mb-6">Other sectors</Eyebrow>
